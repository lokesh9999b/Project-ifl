...
<!doctype html><html class="fixed">
	<head>
		<!-- Basic -->
		<meta charset="UTF-8">
		<title>RAJAHMUNDRY BRANCH</title>
					...
					<div class="row">
						<div class="col">
							<div class="card card-modern">
								...
								$query = "SELECT `ename`, `desig`, `dob`, `doj`, `aadhar`, `contact`, `emp_id` FROM `register` WHERE `branch`= 'rajahmundry 051'";
